...
export default function PredictionForm({ onPredict, isPredicting }) {
  ...
  const inputClasses = "w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 pl-11 text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all peer";
  const labelClasses = "absolute left-11 -top-2.5 bg-slate-900 px-1 text-xs text-slate-400 font-medium transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-sm peer-placeholder-shown:text-slate-500 peer-focus:-top-2.5 peer-focus:text-xs peer-focus:text-primary";
